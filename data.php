                        ...
                        <form method="POST"  enctype="multipart/form-data" name="form1">
                            <div class="row register-form">
                                ...
                                Upload  Photo(MAX 2MB)
						            <input type="file" name="f1" id="uploadfile" accept="image/png, image/gif, image/jpeg, image/jpg" required size="2097152">
                                    </div>
                                    <div class="form-group">
                                Upload  sign(MAX 2MB)
						            <input type="file" name="f2" id="uploadsign" accept="image/png, image/gif, image/jpeg, image/jpg" required size="2097152">
                                    </div>
                                    <div class="form-group">
                                Upload Copyright licence(Upload PDFs only):
						            <input type="file" name="f3" id="uploadresume" accept="application/pdf" required>
                                    </div>
                                    
                                    <div class="form-group">
                                Upload Income Certificate(Upload PDFs only):
                                <input name="upload" type="file" multiple="multiple" accept="application/pdf" required />
                                    </div>
                                    <div class="form-group">
                                Upload Business Licence(Upload PDFs only):
