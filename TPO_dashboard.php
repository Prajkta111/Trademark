                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="sidebar-header" href="#"><i data-feather="box"></i><span>Master</span><i class="fa fa-angle-right pull-right"></i></a>
                            <ul class="sidebar-submenu">
                                <li><a href="TPO_dashboard.php"><i class="fa fa-circle"></i>Trademark company Data</a></li>
                                ...
                                <li><a href="link.php"><i class="fa fa-circle"></i>Trademarks Link</a></li>

                            </ul>

                        </li>
                       <li><a class="sidebar-header" href="#"><i data-feather="box"></i><span>Trademark's Reporting</span><i class="fa fa-angle-right pull-right"></i></a>
                            <ul class="sidebar-submenu">
                            
                            <li><a href="sApply.php"><i class="fa fa-circle"></i>Businesswise Data</a></li>
                            <li><a href="allData.php"><i class="fa fa-circle"></i>Businesses Details Status wise</a></li>  
                            <li><a href="studentStatus.php"><i class="fa fa-circle"></i>Application Status</a></li>
                ...
                <div class="container-fluid border border-white">
                    <form class="needs-validation" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col-md-4">
                            ...
                            <h5 class="para">Enter Name of Trademark</h5>
                            <input type="text" class="form-control" id="company" name="company" placeholder="Enter Name of Trademark" required>
                            </div>
                            <div class="form-group">
                            <h5 class="para">Enter Annual Grossings</h5>
                             <input type="text" class="form-control" id="ctc" name="ctc" placeholder="Enter Annual Grossings" required>
                            </div>
                            <div class="form-group">
                                    <h6 class="para">Eligible Branches</h6>
                                    <input type="checkbox" id="branch1" name="branch[]" value="CO" checked>
                                    <label for="branch1">Tech</label><br>
                                    <input type="checkbox" id="branch2" name="branch[]" value="EJ" checked>
                                    <label for="branch2">Retail</label><br>
                                    <input type="checkbox" id="branch3" name="branch[]" value="ME" checked>
                                    <label for="branch3">Import/export</label><br>
                                    <input type="checkbox" id="branch4" name="branch[]" value="EE" checked>
                                    <label for="branch4">Startup</label><br>
                                    <input type="checkbox" id="branch5" name="branch[]" value="CE" checked>
                                    <label for="branch5">Industial</label><br>
                                    <input type="checkbox" id="branch6" name="branch[]" value="ENTC" checked>
                                    <label for="branch5">Manf.</label><br>
                                     </div>
                            <div class="form-group">
                            <h5 class="para">Enter T&c Rules</h5>
                            <textarea rows="4" cols="60" placeholder="T&c Rules" name="brule" required></textarea>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                        <h5 class="para">Enter Date Of Approval</h5>
                                <input type="date" class="form-control" id="tdate" name="tdate"  required>
                            </div>
                            <div class="form-group">
                          <h5 class="para"> Enter Date Of Accepting</h5>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <p class="pull-right mb-0">Hackathon . All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </footer>
