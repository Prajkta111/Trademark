        ...
        <div class="page-body-wrapper">
                ...
                <div class="sidebar custom-scrollbar">
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="sidebar-header" href="#"><i data-feather="box"></i><span>Business Reporting</span><i class="fa fa-angle-right pull-right"></i></a>
                            ...
                            <li><a href="sApply.php"><i class="fa fa-circle"></i>Businesswise student</a></li>
            ...
            <div class="page-body">
                ...
                <div class="container-fluid border border-white">
                    ...
                    <label style="font-size:25px;">Select a Business:</label>
...
<table border="1" cellspacing="0" cellpadding="4">
    <tr>
        <th>Trademarks Name</th>
        <th>Total Businesses Apply Count</th>
