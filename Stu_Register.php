                        ...
                        <form method="POST"  enctype="multipart/form-data">
                            <div class="row register-form">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control" id="fname" name="fname" placeholder="Name as per aadhar" pattern="[0-9]{12}" title="Name must be 12 digits long" required>
                                    </div>
                                    <div class="form-group">
                                    <input type="number" class="form-control"  id="eno" name="eno" placeholder="Enter ID No." required>
                                    </div>
                                    ...
                                    <div class="form-group"> 
                                    <input type="number" class="form-control" id="age" name="age" placeholder="Enter age" style="margin-bottom:15px;" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <input type="number" class="form-control" id="phno" name="phno" placeholder="Enter Phone No" pattern="[0-9]{12}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     <h6>Select type</h6>
                                      <input type="radio" name="year" value="FY" required> Buisness
                                      <input type="radio" name="year" value="SY"> Partner
                                      <input type="radio" name="year" value="TY"> Seller
                                    </div>
