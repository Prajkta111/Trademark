...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-body-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="sidebar-header" href="#"><i data-feather="box"></i><span>Master</span><i class="fa fa-angle-right pull-right"></i></a>
                            <ul class="sidebar-submenu">
                                 <li><a href="Stu_profile.php"><i class="fa fa-circle"></i>Business Profile</a></li>
                               <li><a href="Aptitude.php"><i class="fa fa-circle"></i>Applied Data</a></li> 
                            </ul>
                        </li>
            ...
            if($row){
                ...
                <td><a href="companyInfo.php?id=<?php echo $res['id']?>"><?php echo $res['company']?></td>
    ...
    <?php
        ...
        if(isset($_POST['apply'])){
            ...
            // Remove the condition that checks if $today < $enddate
            ...
            $array = explode(',', $cbranch);
            
            // Remove the conditional checks and directly proceed to insertion
