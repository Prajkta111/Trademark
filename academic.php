        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="final_logo-min.png" alt="">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form method="POST"  enctype="multipart/form-data" name="form1">
                            <div class="row register-form">
                                <div class="col-md-6">
                               select Type:<br>
                                <input type="radio"  name="branch"  value="CO" required/> Tech
                                <input type="radio"  name="branch"  value="EJ"/> Retail
                             <input type="radio"  name="branch"  value="ME"/>  Import/export 
                             <input type="radio"  name="branch"  value="EE"/>   Startup 
                             <br>  <input type="radio"  name="branch" value="CE"/> Industial 
                              <input type="radio"  name="branch"  value="ENTC"/> Manf. 


                                <br><br>
                                    <div class="form-group">
                                    <input type="text" class="form-control"  id="code" name="code" placeholder="Enter pin code" required>
                                    </div>
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="year" name="year" placeholder="Enter current year" required>
                                    </div>
                                    <div class="form-group">
                                    Select shift<br>
                                    ...
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="avg" name="tenth" placeholder="Enter Owners equity %" required>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="cyear" name="FY" placeholder="Enter 1st Partners %" style="margin-bottom:15px;" required>
                                    </div>

                                    <div class="form-group">
                                    <input type="text" class="form-control" id="addyear" name="SY" placeholder="Enter 2nd Partners %" required>
                                    </div>

                                    <div class="form-group">
                                    <input type="text" class="form-control" id="ayear" name="ayear" placeholder="Enter Launch Year" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="backlogs" name="backlogs" placeholder="Number Banckrupse" required>
                                    </div>
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="liveBack" name="liveBack" placeholder="Live Loss" required>
                                    </div>

                                    <div class="form-group">
                                    Select Current Business Level<br>  
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <input type="text" class="form-control" id="pyear" name="pyear" placeholder="Enter Year of startup" required>
                                    </div>
                                    Select Type of Businesses :<br>

<input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck" required/>Regular

<input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck" />Startup
<br><br>


         <label for="sem1" id="a">Enter Profit margin:</label>
          <input type="text" class="form-control ifYes" id="sem1" name="sem1" >
        
          <label for="sem2" id="b">Enter 2nd Profit margin:</label>
          <input type="text" class="form-control ifYes" id="sem2" name="sem2" >
       
          <label for="sem3">Enter 3rd Profit margin:</label>
          <input type="text" class="form-control " id="sem3" name="sem3" required>
   
          <label for="sem4">Enter 4th Profit margin:</label>
          <input type="text" class="form-control " id="sem4" name="sem4" required>
   
          <label for="sem5">Enter 5th Profit margin:</label>
          <input type="text" class="form-control " id="sem5" name="sem5" required>
       
          <label for="sem6">Enter 6th Profit margin:</label>
