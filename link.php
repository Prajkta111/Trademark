        ...
        <div class="page-body-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="sidebar-header" href="#"><i data-feather="box"></i><span>Master</span><i class="fa fa-angle-right pull-right"></i></a>
                            <ul class="sidebar-submenu">
                                <li><a href="TPO_dashboard.php"><i class="fa fa-circle"></i>Trademark Data</a></li>
                        ...
                        <li><a class="sidebar-header" href="#"><i data-feather="box"></i><span>Business Reporting</span><i class="fa fa-angle-right pull-right"></i></a>
                            <ul class="sidebar-submenu">
                            
                            <li><a href="sApply.php"><i class="fa fa-circle"></i>Businesswise Data</a></li>
                            <li><a href="allData.php"><i class="fa fa-circle"></i>Business Details Status wise</a></li>  
            ...
            <div class="page-body">
                ...
                <div class="container-fluid border border-white">
                    ...
                    <label style="font-size:20px;margin-left:4%;">Select a Business:</label>
            ...
            if($row)
            {
                while($res=mysqli_fetch_array($query)){
                    ...
                    $_SESSION['sname'] = $res['sname'];
                    $_SESSION['companyid']=$res['companyid'];
                    
                        ?>
                            <tr>
                            <td><input type="checkbox" name="selected[]" value="<?php echo $res['eno'];?>"></td>
...
?>
            ...
            <tr>
            <td colspan="4"><button type="submit"  class="btn btn-primary" id="select" name="select" >Submit</button></td>
</tr>
<?php
               ?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-xs-12 footer-copyright">
                            <p class="mb-0">Copyright &copy 2024-25 </p>
                        </div>
  ...
  if(isset($_POST['select'])) {
    if(!empty($_POST['selected'])) {
      foreach($_POST['selected'] as $selected) {
        $sql2 = "select * from `link` where eno= '$selected'";
        $result = mysqli_query($conn,$sql2);
        $data = mysqli_fetch_array($result);
        $cid = $data['companyid'];
        $sql = "INSERT INTO selected_student (checkboxValue,cid,status) VALUES ('$selected','$cid','selected')";
